...
//////COLOQUEI GRUPO 11 MAS CASO NÃO FOR O MEU É DO MARCELO HENRIQUE O TRABALHO
...
struct ArrayDinamico // estrutura do array dinâmico
{
    ...
    Aluno **ptr_dados; // array de struct aluno que representa nossos dados.
};
    ...
    for (i = 0; i < arrayDinamico->quantidade; i++)
    {
        if (qtdInfo == 2) // imprime todas as informações
        {
            ...
            printf("Aluno %d\nNome: %s\nRA: %d\nData de Nascimento: %s\nEndereco 1:\n Rua: %s\n Numero Casa: %d\n Estado: %s\n Cidade: %s \n Bairro: %s\nEndereco 2:\n Rua: %s\n Numero Casa: %d\n Estado: %s\n Cidade: %s\n Bairro: %s\nMateria 1 - Nome: %s | Media: %f\nMateria 2 - Nome: %s | Media: %f\nMateria 3 - Nome: %s | Media: %f\nMateria 4 - Nome: %s | Media: %f\nMateria 5 - Nome: %s | Media: %f\n",
                   ...
                   arrayDinamico->ptr_dados[i]->endereco[0].rua,
                   arrayDinamico->ptr_dados[i]->endereco[0].numeroCasa,
                   arrayDinamico->ptr_dados[i]->endereco[0].estado,
                   arrayDinamico->ptr_dados[i]->endereco[0].cidade,
                   arrayDinamico->ptr_dados[i]->endereco[0].bairro,
                   arrayDinamico->ptr_dados[i]->endereco[1].rua,
                   arrayDinamico->ptr_dados[i]->endereco[1].numeroCasa,
                   arrayDinamico->ptr_dados[i]->endereco[1].estado,
                   arrayDinamico->ptr_dados[i]->endereco[1].cidade,
                   arrayDinamico->ptr_dados[i]->endereco[1].bairro,
...
void imprimeAluno(Aluno *aluno)
{
    ...
    if (aluno != NULL)
    {
        ...
        printf("Nome: %s\nRA: %d\nData de Nascimento: %s\nEndereco 1:\n Rua: %s\n Numero Casa: %d\n Estado: %s\n Cidade: %s \n Bairro: %s \nEndereco 2:\n Rua: %s\n Numero Casa: %d\n Estado: %s\n Cidade: %s\n Bairro: %s\nMateria 1 - Nome: %s | Media: %f\nMateria 2 - Nome: %s | Media: %f\nMateria 3 - Nome: %s | Media: %f\nMateria 4 - Nome: %s | Media: %f\nMateria 5 - Nome: %s | Media: %f\n",
               ...
               aluno->endereco[0].rua,
               aluno->endereco[0].numeroCasa,
               aluno->endereco[0].estado,
               aluno->endereco[0].cidade,
               aluno->endereco[0].bairro,
               aluno->endereco[1].rua,
               aluno->endereco[1].numeroCasa,
               aluno->endereco[1].estado,
               aluno->endereco[1].cidade,
               aluno->endereco[1].bairro,
...
void menuCriarAluno(ArrayDinamico *arrayDinamico)
{
    ...
    {
        setbuf(stdin, NULL);
        printf("Digite a rua %d do aluno: ", i + 1);
        fgets(aluno->endereco[i].rua, sizeof(aluno->endereco[i].rua), stdin);
        strcpy(aluno->endereco[i].rua, ajustarString(aluno->endereco[i].rua));

        printf("Digite o numero %d da casa do aluno: ", i + 1);
        scanf("%d", &aluno->endereco[i].numeroCasa);

        setbuf(stdin, NULL);
        printf("Digite o bairro %d do aluno: ", i + 1);
        fgets(aluno->endereco[i].bairro, sizeof(aluno->endereco[i].bairro), stdin);
        strcpy(aluno->endereco[i].bairro, ajustarString(aluno->endereco[i].bairro));

        setbuf(stdin, NULL);
        printf("Digite a cidade %d do aluno: ", i + 1);
        fgets(aluno->endereco[i].cidade, sizeof(aluno->endereco[i].cidade), stdin);
        strcpy(aluno->endereco[i].cidade, ajustarString(aluno->endereco[i].cidade));

        setbuf(stdin, NULL);
        printf("Digite o estado %d do aluno: ", i + 1);
        fgets(aluno->endereco[i].estado, sizeof(aluno->endereco[i].estado), stdin);
        strcpy(aluno->endereco[i].estado, ajustarString(aluno->endereco[i].estado));
    }
    ...
    {
        setbuf(stdin, NULL);
        printf("Digite o nome da materia %d do aluno: ", i + 1);
        fgets(aluno->materia[i].nomeMateria, sizeof(aluno->materia[i].nomeMateria), stdin);
        strcpy(aluno->materia[i].nomeMateria, ajustarString(aluno->materia[i].nomeMateria));

        printf("Digite a media da materia %d do aluno: ", i + 1);
        scanf("%f", &aluno->materia[i].mediaMateria);
        i++;
    }
